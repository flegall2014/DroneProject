...
ApplicationWindow {
    ...
    Rectangle {
        ...
        LoginPage {
            ...
            width: parent.width
            onLoginClicked: {
                MASTERCONTROLLER.startComStation()
